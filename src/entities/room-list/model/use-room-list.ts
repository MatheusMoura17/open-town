...
import {
  ...
  removeRoomFromRepo,
  getRoomByIdFromRepo,
} from '../api/room-repository'
import { useRoomListStore } from './room-list-store'
import { deserializeRoom, serializeRoom, type IRoom } from '../../room/model/room'
...
export const useRoomList = () => {
  ...
  const createRoom = (displayName: string, ownerId: string, roomId?: string) => {
    const room = {
